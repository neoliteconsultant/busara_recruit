...
class JobTestCase(TestCase):
    ...
    def setUpTestData(self):
        ...
        self.employer = Employer.objects.create(user=self.user, company_name="Quartz Accountants",
                                                company_website="https://www.quartz.io", phone_number="245711300900")
    ...
    def test_successful_job_creation(self):
        ...
        request = self.factory.post('/jobs/create', {'employer': self.employer, 'title': title, 'industry': industry,
    ...
    def test_apply_job(self):
        ...
        job = Job.objects.create(employer=self.employer, title="Sr. Backend developer", industry="IT and Telecoms",
                                 location="Nairobi, Kenya", availability="Part time", description="IT Guru",
                                 requirements="Bsc Computer Science")
