...
def dashboard(request):
	try:
		...
		if request.user.is_authenticated:
			...
			return render(request,'employers/index.html',{'company_name':employer_name,'notifications':notifications,'total_jobs':total_jobs,'total_candidates':total_candidates,'shortlisted_candidates':shortlisted_candidates})
		else:
