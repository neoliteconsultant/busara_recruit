...
def schedule_interview(request, employee_id):
    ...
    if request.method == 'POST':
        ...
        interview = Interview(employee=employee, interview_type=interview_type, location=location,
        ...
        return render(request, 'interviews/schedule_interview.html',
                      {'company_name': employer.company_name, 'interviewee': interviewee})
...
def my_interviews(request):
    ...
    return render(request, 'interviews/view_interviews.html',
                  {'interviews': interviews, 'company_name': employer.company_name})
